...
type UiCollapseTransition = typeof import('./src/components/transition/collapse-transition.vue')
type UiCollapseRoot = typeof import('./src/components/collapse/collapse-root.vue')
type UiCollapseContent = typeof import('./src/components/collapse/collapse-content.vue')
type UiCollapseTrigger = typeof import('./src/components/collapse/collapse-trigger.vue')
...
declare module 'vue' {
	export interface GlobalComponents {
		...
		UiCollapseTransition: UiCollapseTransition['default']
		UiCollapseRoot: UiCollapseRoot['default']
		UiCollapseContent: UiCollapseContent['default']
		UiCollapseTrigger: UiCollapseTrigger['default']
	}
}
